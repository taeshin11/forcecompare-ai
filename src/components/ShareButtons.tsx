  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-2 py-4 px-4">
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#1877f2]/10 text-[#1877f2] hover:bg-[#1877f2]/20 transition-colors text-xs font-medium"
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#25d366]/10 text-[#25d366] hover:bg-[#25d366]/20 transition-colors text-xs font-medium"
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0088cc]/10 text-[#0088cc] hover:bg-[#0088cc]/20 transition-colors text-xs font-medium"
